...
function showCart() {
    ...
    cartItems.map(ci => {
        ...
        //Bruker let konsekvent fordi det skal kjøre flere ganger, bytter etterhvert?
        ...
        //Summere totalpris
        //Legge til det som allerede finnes der
    ...
    document.getElementById("cart_quantity").innerHTML = cart.length
...
function addToCart(prodid) {
    ...
    //Oppdater handlevisning (må generere HTML hver gang vi kjører showCart)
    showCart()
}
